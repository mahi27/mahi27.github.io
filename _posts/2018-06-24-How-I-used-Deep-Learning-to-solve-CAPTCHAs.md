...
permalink: /How-I-used-Deep-Learning-to-solve-CAPTCHAs
published: true
images:
  - url: /images/app_gif.gif
---
...
<p>Check out <a href="https://blog.keras.io/building-powerful-image-classification-models-using-very-little-data.html">keras blog</a> for tutorials on building the model. It can be achieved in few lines of code! </p>
...
<img src="images/app_gif.gif" align="middle">
<p>Wanna try it out? Download the python script for the app <a href="https://github.com/mahi27/mahi27.github.io/blob/master/Scripts/app.py"> here</a></p>
